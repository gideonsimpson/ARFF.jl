...
"""
function mse_loss(F::ScalarFourierModel{TR,TY,TI,TA}, data_x::Vector{Vector{TR}}, data_y::Vector{TY}) where {TR<:AbstractFloat,TY<:Number,TI<:Integer,TA<:ActivationFunction{TY}}
...
* `data_y` - the y coordinates in training data
"""
function mse_loss(F::VectorFourierModel{TR,TY,TI,TA}, data_x::Vector{Vector{TR}}, data_y::Vector{Vector{TY}}) where {TR<:AbstractFloat,TY<:Number,TI<:Integer,TA<:ActivationFunction{TY}}
